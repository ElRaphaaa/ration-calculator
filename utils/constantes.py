...
# --- Chatte gestation/lactation (NRC 2006 §3) ---
PB_MCAL_GESTATION_CHATTE = 95
CA_MCAL_GESTATION_CHATTE = 2.7
P_MCAL_GESTATION_CHATTE = 1.9

# --- Chaton croissance (NRC 2006 §3) ---
PB_MCAL_CROISSANCE_CHATON = 95
CA_MCAL_CROISSANCE_CHATON = 2.0
P_MCAL_CROISSANCE_CHATON = 1.8